  ...
  const matchesSM = useMediaQuery(theme.breakpoints.down("sm"));
    ...
    >
      ...
      >
        <Grid item>
            <Typography  variant="h3" align={matchesMD ? 'center' : undefined} >
              Hi There !  <span className="wave" style={{fontWeight:'normal'} }role="img" aria-labelledby="wave">👋🏻</span>
            </Typography>
          ...
          >
            ...
            >
              <Button
                ...
                variant="contained"
                onClick={
                ()=>window.open('https://docs.google.com/document/d/1MZlChP3a_7mXakfGxWy0aZPrRJJsQ9nRICbjoThQB68/edit', '_blank')
                }
              >
                Resume
              </Button>
      ...
      <Grid item container justifyContent={matchesMD ? "center" : "flex-end"} md={5}>
         <DisplayLottie animationData={programmer} style={{ maxWidth: "40em", margin: 0 }} />
      </Grid>
    </Grid>
    <Grid item>
      <Skills />
